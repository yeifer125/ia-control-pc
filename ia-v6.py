...
REGLAS:
- Si la acción requiere comandos de Windows (cmd, powershell, exe) → action = "windows_shell"
- Si la acción requiere comandos Linux → action = "wsl_shell"
- Nunca mezcles sintaxis Windows y Linux en la misma acción
